        ...
        for attempt in range(self.max_attempts):
            try:
                ...
                for anime_to_add in anime_to_add_list:
                    ...
                    self.added_anime["current_season"] = anime_to_add[3]
                    self.added_anime["episode"] = anime_to_add[4]
                    self.added_anime["torrent_provider"] = anime_to_add[5]
                    self.added_anime["image_url"] = anime_to_add[6]
                    self.added_anime["download_day"] = anime_to_add[7]
                    self.added_anime["live_chart_url"] = anime_to_add[8]

                    embed = discord.Embed(
                        title="Added anime to the download list",
                ...
                self.logger.error(f"Error in addAnimeFromLiveChartsProfile({line_number}): {e}")
